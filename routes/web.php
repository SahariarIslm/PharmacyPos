...
Route::prefix('customer')->name('customer.')->group(function () {
    ...
    Route::get('/delete', 'CustomerController@destroy')->name('destroy');
...
Route::prefix('purchase')->name('purchase.')->group(function () {
    ...
    Route::any('/getPrice', 'PurchaseController@getPrice')->name('getPrice');
...
Route::prefix('stock')->name('stock.')->group(function () {
    ...
    Route::get('/batch-wise', 'StockController@batch_wise')->name('batch.wise');
    ...
    Route::get('/expiry-print', 'StockController@expiry_print')->name('expiry.print');
    Route::get('/expired-print', 'StockController@expired_print')->name('expired.print');
});

//-------------------------- Sale ------------------------
Route::prefix('sale')->name('sale.')->group(function () {
    Route::get('/list', 'SaleController@index')->name('index');
    Route::any('/getBatches', 'SaleController@getBatches')->name('getBatches');
    Route::post('/add-item', 'SaleController@add_item')->name('item');
    Route::post('/add-batch', 'SaleController@add_batch')->name('batch');
...
Route::prefix('batch/stock')->name('batch.stock.')->group(function () {
    Route::get('/expiry', 'StockController@expiry')->name('expiry');
    Route::get('/expired', 'StockController@expired')->name('expired');
}); 