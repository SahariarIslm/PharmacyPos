    ...
    <nav id="sidebar" class="">
        <div class="sidebar-header">
            <a href="{{ route('frontend') }}">
                <img class="main-logo" src="{{ asset('/public') }}/Master/img/logo/logo_image.png" 
                    alt="Dokan Pos" style="width:205px; padding-left: 5px;"/>
            </a>
            <strong>
                ...
                <ul class="metismenu" id="menu1">
                        ...
                        <ul class="submenu-angle" aria-expanded="true">
                            ...
                            <li>
                                <a title="Delivery" href="{{ route('delivery.index') }}">
                                    ...
                                    <span class="mini-sub-pro">Delivery</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <ul class="submenu-angle" aria-expanded="true">
                            <li>
                                <a title="Product" href="{{ route('product.index') }}">
                                    ...
                                    <span class="mini-sub-pro">Medicine List</span>
                                </a>
                            </li>
                            <li>
                    ...
                    <li class="">
                        ...
                        <ul class="submenu-angle" aria-expanded="true">
                            ...
                            <li>
                                <a title="Batch Wise Stock" href="{{ route('stock.batch.wise') }}">
                                    <i class="fa fa-shopping-bag sub-icon-mg" aria-hidden="true"></i> 
                                    <span class="mini-sub-pro">Batch Wise Stock</span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a title="3 Months Expiry Report" href="{{ route('batch.stock.expiry') }}">
                                    <i class="fa fa-file-o sub-icon-mg" aria-hidden="true"></i> 
                                    <span class="mini-sub-pro">3 Months Expiry</span>
                                </a>
                            </li>
                            <li>
                                <a title="Expired Date Report" href="{{ route('batch.stock.expired') }}">
                                    <i class="fa fa-file sub-icon-mg" aria-hidden="true"></i> 
                                    <span class="mini-sub-pro">Expired Date</span>
                                </a>
                            </li>
                        </ul>
                    </li>
