                    ...
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 class="col-lg-4 p-0"  style="padding:0px;">
                                Medicine<span class="table-project-n"></span> List
                            </h1>
                            ...
                            <a class="btn btn-info col-lg-2 Primary" style="float:right;" href="{{ route('product.create') }}" role="button">Add Medicine</a>
                            <a class="btn btn-primary col-lg-2 Primary" style="float:right; margin-left: 5px;" href="{{ route('product.importView') }}" role="button">Medicine Import</a>
                        </div>
                    </div>
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" 
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="generic_name" data-editable="false">Gen. Name</th>
                                        <th data-field="barcode" data-editable="false">Barcode</th>
                                        <th data-field="category" data-editable="false">Category</th>
                                        <th data-field="medicine_unit" data-editable="false">Unit</th>
                                        <th data-field="min_stock" data-editable="false">Min. Stock</th>
                                        <th data-field="price" data-editable="false">Price</th>
                                        <th data-field="manufacturer" data-editable="false">Manufacturer</th>
                                        <th data-field="manufacturer_price" data-editable="false">Manuf. Price</th>
