                ...
                <div class="sparkline13-list">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 class="col-lg-4 p-0" style="padding:0px;">
                                Delivery Company<span class="table-project-n"></span> Table
                            </h1>
                            ...
                            <button type="button" class="btn btn-info col-lg-2 Primary" style="float:right;" 
                                data-toggle="modal" data-target="#PrimaryModalalert">Add Delivery Company
                            </button>
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog">
                            ...
                            <form action="{{ route('delivery.store') }}" method="POST">
                                ...
                                <div class="modal-header header-color-modal bg-color-1">
                                    <h4 class="modal-title">Add Delivery Company Info</h4>
                                </div>
                    ...
                    <div id="InformationproModalhdbgcl" class="modal modal-adminpro-general default-popup-PrimaryModal fade" role="dialog">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header header-color-modal bg-color-1">
                                    <h4 class="modal-title">Edit Delivery Company Info</h4>
                                    <div class="modal-close-area modal-close-df">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="datatable-ct w-25" style="width:25%;">
                                            ...
                                            @endcan
                                            @if($data->status == "1")
                                                <a href="{{route('delivery.status',['id'=>$data->id])}}" 
                                                    class="btn btn-warning btn-xs"
                                                    onclick="return confirm('Are You Sure You Want To Change Delivery Company Status ??')">
                                                    <i class="fa fa-arrow-down" 
                                                    title="Change Delivery Company Status to Inactive ??"></i>
                                                </a>
                                            @elseif($data->status == "0")
                                                <a href="{{route('delivery.status',['id'=>$data->id])}}" 
                                                    ...
                                                    title="Change Delivery Company Status to Active ??"></i>
                                                </a>
                                            @endif
                                        </td>
                                    </tr>
